...
(function ($) {
  "use strict";
  const formURL =
    "https://script.google.com/macros/s/AKfycbyc23tpeLRuYjkIzm0ltiw6xIkeGQJhShpFsBMu/exec";
  const socialURL = {
  ...
  const projects = [
    ...
    DataProjectBuilder.make()
      ...
      .setTitle("Simayapada")
      .setDesc(
        "Manajemen data lelang daerah yang diambil dari aplikasi RUP dan LPSE",
      )
      .setCategory("Information System")
  ...
  $(window).on("load", function () {
    $(".loader").fadeOut(1000);
    var yearStartAsProgrammer = 2020;
...
function showModalDetailProject(project) {
  ...
  modalElement
    .find(".project-used-technologies span")
    .html(project.usedTechnologies.join(", "));
...
function buildFeaturedProjects(projects) {
  ...
  projects.forEach(function (project) {
    ...
    featuredWorksContainer
      .find(`[data-project="${project.keyname}"]`)
